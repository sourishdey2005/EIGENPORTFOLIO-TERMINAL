...
- **Deployments fail to fetch data**: set `ALPHAVANTAGE_API_KEY` in deployment secrets, keep **Max Stocks (Fetch)** at 10 or below, and keep **Fetch Delay (sec)** near 2s so Yahoo can run first and Alpha Vantage can backfill failures.
